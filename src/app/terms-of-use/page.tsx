            ...
            <div id="termsOfUse" className="text-gray-600 space-y-6">
              <div>
                ...
                <p className="mt-3 leading-[1.8] text-xs md:text-sm xl:text-base">
                  By accessing the Condacton Technologies Limited platform and
              ...
              <ul className="list-none space-y-5 text-xs md:text-sm xl:text-base">
                <li>
                  ...
                  Condacton Technologies Limited operates on a two-phase payment
                ...
                <li>
                  ...
                  7-14 days; Sea: 45-60 days) are estimates. Condacton
                  Technologiesl Innovations is not liable for delays caused by
                ...
                <li>
                  ...
                  market volatility. Condacton Technologies Limited reserves the
                ...
                <li>
                  ...
                  list. Condacton Technologies Limited reserves the right to
                  cancel procurement for items deemed illegal or restricted.
                </li>
              ...
              <div className="bg-slate-50 p-4 rounded-2xl border border-slate-100 mt-6">
                <p className="leading-[1.6] text-xs md:text-sm italic">
                  ...
                  Condacton Technologies Limited acts as a procurement and
          ...
          {activeTab === "privacyPolicy" && (
            <div id="privacyPolicy" className="text-slate-600 space-y-8">
              ...
              <div>
                ...
                <p className="mt-3 leading-[1.8] text-xs md:text-sm xl:text-base">
                  Condacton Technologies Limited collects personal information
                  to provide a secure, seamless international procurement and
                ...
                <ul className="mt-4 space-y-3 text-xs md:text-sm xl:text-base list-none pl-0">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      ...
                      protect the Condacton Technologies Limited ecosystem.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="mt-1.5 size-1.5 rounded-full bg-primary-100 shrink-0" />
              ...
              <div className="bg-slate-900 text-white p-8 rounded-[2.5rem] shadow-xl relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="mt-4 leading-[1.8] text-xs md:text-sm xl:text-base opacity-80">
                    Condacton Technologies Limited employs bank-grade AES-256
