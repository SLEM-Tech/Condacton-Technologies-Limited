      ...
      <div>
        ...
        <p className="text-sm md:text-base leading-relaxed max-w-4xl">
          ...
          <span className="font-bold text-slate-900">
            Condacton Technologies Limited
          </span>
      ...
      <div className="bg-white border border-slate-200 rounded-3xl p-8 space-y-6 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4 text-xs md:text-sm">
          ...
          <p>
            ...
            Condacton Technologies Limited bears no responsibility for items
            signed for by unauthorized third parties.
          </p>
          <p>
            •{" "}
        ...
        <div className="pt-4 flex items-center gap-3 text-xs font-bold text-primary-100">
          Queries:{" "}
          <a
            href="mailto:IgweBlessing@Condacton.com.ng"
            className="hover:underline">
            IgweBlessing@Condacton.com.ng
          </a>
        </div>
      </div>
