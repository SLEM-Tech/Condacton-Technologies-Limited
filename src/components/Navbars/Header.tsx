        ...
        <div className="hidden slg:flex items-center justify-between w-full py-4 max-w-[1440px] px-4 sm:px-8 mx-auto">
          ...
          <div className="flex items-center gap-5">
            ...
            <Menu as="div" className="relative inline-block text-left">
              {({ open }) => (
                <>
                  <Menu.Button className="flex items-center gap-2 cursor-pointer group outline-none focus:ring-0 text-[#23A6F0] hover:text-[#23A6F0]/80 transition text-sm font-bold">
                      ...
                      : <div className="flex flex-col gap-1">
                          <Menu.Item>
                            {({ active }) => (
                              <Link
                                href="/user/login"
                                className={`${active ? "bg-gray-50 text-gray-900" : "text-gray-600"} flex w-full items-center gap-3 rounded-xl px-3 py-3 text-sm transition-colors`}>
                                Login
                              </Link>
                            )}
                          </Menu.Item>
            ...
            <button
              ...
              className="text-[#23A6F0] hover:text-[#23A6F0]/80 transition cursor-pointer">
              <FiSearch className="text-xl" />
            </button>

            {/* Cart */}
            <div
              className="relative cursor-pointer flex items-center gap-1.5 text-[#23A6F0] hover:text-[#23A6F0]/80 transition"
              onClick={onOpenCart}>
            ...
            <Link
              href="/user/wishlist"
              className="relative flex items-center gap-1.5 text-[#23A6F0] hover:text-[#23A6F0]/80 transition">
